...
public class AgentPipeline
{
    ...
    /// <summary>
    /// 从 DI 容器解析 IChatClient 创建管道
    /// </summary>
    public AgentPipeline(IServiceProvider serviceProvider)
    {
    ...
    {
        var middleware = ActivatorUtilities.GetServiceOrCreateInstance<TMiddleware>(_serviceProvider);
        _middlewares.Add(middleware);
        return this;
    }
