...
public static class ToolCallerEmitter
{
    public static string Emit(string namespaceName, List<ToolMethodModel> tools)
    {
        var option = Code.Create()
            ...
            .Using("System", "System.Collections.Generic", "System.Threading", "System.Threading.Tasks", "ManInBlack.AI.Core.Tools", "Microsoft.Extensions.DependencyInjection")
            .Namespace(ns => {
    ...
    private static string[] BuildFilterPipelineLines(ToolMethodModel tool)
    {
        ...
        // 核心调用作为最内层委托
        lines.Add("System.Func<ManInBlack.AI.Core.Tools.ToolExecuteContext, System.Threading.Tasks.Task> next = async ctx =>");
        lines.Add("{");
