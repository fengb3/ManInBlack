...
public class FileToolsTests : IDisposable
{
    ...
    public void WriteFile_Temp目录内_写入成功()
    {
        ...
        var result = _tools.WriteFile(filePath, "temp content");
    ...
    public void WriteFile_Temp目录内_自动创建父目录()
    {
        ...
        var result = _tools.WriteFile(filePath, "deep content");
    ...
    public void WriteFile_不允许的目录_拒绝()
    {
        ...
        var result = _tools.WriteFile(filePath, "bad content");
    ...
    public void UpdateFile_Temp目录内_替换成功()
    {
        ...
        var result = _tools.UpdateFile(filePath, "hello", "goodbye");
    ...
    public void UpdateFile_不允许的目录_拒绝()
    {
        ...
        var result = _tools.UpdateFile(filePath, "old", "new");
